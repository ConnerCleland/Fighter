...
const enemy = new Fighter({
  ...
  sprites: {
    ...
    run: {
      imageSrc: './img/Run blue.png',
      framesMax: 8
    },
    jump: {
      imageSrc: './img/Jump blue.png',
      framesMax: 2
    },
    fall: {
      imageSrc: './img/Fall blue.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: './img/Attack1 blue.png',
      framesMax: 4
    },
    takeHit: {
      imageSrc: './img/Take hit blue.png',
      framesMax: 3
    },
    death: {
      imageSrc: './img/Death blue.png',
      framesMax: 7
    }
  },
  attackBox: {
